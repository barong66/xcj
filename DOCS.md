...
- **Accounts** — добавлять/удалять источники контента, запускать парсинг
...
- Публичные эндпоинты: видео, категории, поиск, аналитические события
...
- Публичная часть: витрина видео, поиск, категории
...
- **events** — все события (impression, click, hover, view)
